...
document.addEventListener('DOMContentLoaded', function () {
    App.Player = new _player2.default();
});
...
var Player = function () {
    function Player() {
        ...
        this.controls = '[data-player-controls]';
        this.play = '[data-player-controls-play]';
        this.prev = '[data-player-controls-prev]';
        this.next = '[data-player-controls-next]';
        this.audioPassed = '[data-player-timeline-passed]';
        this.audioDuration = '[data-player-timeline-duration]';
        this.progressbar = '[data-player-timeline-progressbar]';
    ...
    _createClass(Player, [{
        ...
        value: function timePassed() {
            ...
            $audio.ontimeupdate = function () {
                ...
                var $progression = Math.floor($audioCurrentTime / $audioDuration * 100);
        ...
        value: function bindEvents() {
            ...
            $(this.progressbar).on("click", function (e) {
                e.preventDefault();
                var $audio = document.getElementById("audio");
                var timeLinePos = $(this).offset().left;
                var timeLineWidth = $(this).width();
                var position = e.pageX - timeLinePos;
                var percents = position / timeLineWidth * 100;
                var trackPosition = $audio.duration / 100 * percents;
